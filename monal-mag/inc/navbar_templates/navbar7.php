<!-- Nav 1  -->
<div class="border-b fixed top-[30px] z-10 bg-gray-50 w-full ">
                            ...
                            if (has_nav_menu('primary')) {
                                wp_nav_menu(
                                    array(
                                        ...
                                        'li_class' => "relative block text-sm font-medium text-[#ffffff] transition duration-300 border-b-2 border-white hover:border-gray-900"
                                    )
                                );
                            } else {
                                wp_nav_menu(
