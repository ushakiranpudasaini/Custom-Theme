<!-- Nav 1  -->
<div class="    w-full  border-gray-200 dark:border-gray-700  border-b lg:py-0 dark:bg-gray-900 ">
                            ...
                            if (has_nav_menu('primary')) {
                                wp_nav_menu(
                                    array(
                                        ...
                                        'li_class' => "relative block text-sm font-medium text-gray-100 transition duration-300 "
                                    )
                                );
                            } else {
                                wp_nav_menu(
